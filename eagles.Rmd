...
knitr::kable(qb, col.names = c("", "Passing Attempts", "Passing Yards", "Touchdown Passes", "Interceptions", "Fumbles", "Lost Fumbles", "Rushing Yards", "Yards Per Attempt"))
```
